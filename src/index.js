...
const encode = (o:any) => packr.pack(o);

const decode = (b:Buffer) => packr.unpack(b);
...
class ClusterNode extends events.EventEmitter {
  ...
  declare advertisePeersInterval: IntervalID;
  declare advertisePeersTimeout: TimeoutID | void;
